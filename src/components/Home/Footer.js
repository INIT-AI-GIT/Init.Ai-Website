...
const Footer = () => {
  ...
  const emailclick = () => {
    window.open("mailto:djsceinit.ai17@gmail.com", "_blank");
  };

  const instaclick = () => {
    window.open("https://www.instagram.com/djinit.ai", "_blank");
  };

  const linkedinclick = () => {
    window.open("https://www.linkedin.com/company/init-ai", "_blank");
  };
    ...
    <footer className="footer text-white h-screen w-screen flex flex-wrap  justify-center md:justify-evenly items-center ">
      ...
      <div className="md:h-[40%]">
        ...
        <div className=" flex flex-col md:gap-5 gap-3 items-center">
          <div className="">
            <EnvelopeAtFill
              className="h-[25px] w-[25px] md:h-[35px] cursor-pointer md:w-[35px]"
              onClick={emailclick}
            />
          </div>
          <div className="">
